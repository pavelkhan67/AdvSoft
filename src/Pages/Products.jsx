...
const Products = () => {
    ...
    return (
        <div className="mt-10 lg:mt-12" id='product'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-1 md:gap-2 lg:gap-4 mt-3 md:mt-5 px-1 lg:px-0'>
                <div className="card bg-base-100 shadow-xl border border-slate-300">
                    ...
                    <div className=' rounded-b-xl text-white ps-2 pe-1 py-4' style={{ backgroundColor: '#730B53' }}>
                        ...
                        <p><a href='' className='underline'>Product Link</a></p>
                        ...
                        <button onClick={scrollToContactSection} className='btn btn-sm bg-white w-fit mt-3' href="">Contact for Service<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5m-6-15l7.5 7.5-7.5 7.5" />
                        </svg></button>
