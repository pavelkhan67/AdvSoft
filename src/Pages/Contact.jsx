    ...
    return (
        <div class="text-center bg-white pt-10 lg:pt-12 pb-14" id='contact'>
            ...
            <div class="md:flex gap-6 justify-center">
                <button
                    class="mt-6 h-fit w-fit py-2 px-6 text-sm text-white bg-blue-500 rounded-md transition-transform duration-500 hover:bg-white hover:text-blue-400 hover:scale-x-110 transform origin-center border hover:border-blue-500">
                    SALES: +001122334455
